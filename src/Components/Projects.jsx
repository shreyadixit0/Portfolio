...
const projects = [
  ...
  {
    title: "ResumeX",
    description:"ResumeX is a resume screening app that provides an ATS score, suggests improvements, and helps users build stronger resumes with guided feedback.",
  ...
  },
  {
    ...
    description: "A Library Management System with integrated chatbot support for student queries. Manages book inventory, issue/return tracking, offering interactive experience for both users and admins.",
...
export default function Projects() {
  return (
    <section
      id="projects"
      className="min-h-screen px-6 py-20 bg-base 100 text-base-content"
    >
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="rounded-2xl backdrop-blur-xl bg-white/5 border border-white/10 shadow-md rounded-2xl p-10 justify-between"
            >
              <div>
